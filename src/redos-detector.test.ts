  ...
  describe('isSafe', () => {
    describe('cases', () => {
      ...
      const cases: Case[] = [
        ...
        [/(ab){0,2}a(ba)?/, false],
        [/(ab){0,2}a(baba)?/, false],
        [/(ab){0,2}a(bababa)?/, true],
        [/(abc?){0,2}a(bababa)?/, true],
        [/(a|b){0,2}a?/, false],
        [/(a|b){0,2}(a|b)?/, false],
        [/(a|b){0,2}c?/, true],
        [/(){0,2}c?/, true],
        ...
        [/(ab?c)*a(cabcab)?/, true],
        // acabcab
        [/(ab?c)*a(cabcab)?c/, true],
        // acabcabc
        [/(ab?c)*a(bcabcab){1,2}/, true],
        ...
        // acac
        [/(ab?c)*a(cab){0,1}c/, true],
        // acabc can't match multiple ways
        [/(ab?c)*ab(cab){0,1}c/, false],
        // abcabc
        [/(ab?c)*ab(ca){0,1}c/, true],
        // abcac doesn't work
        [/(abc)*a(bca){0,1}bc/, false],
        [/(abc)*a(bc){0,1}abc/, true],
        [/(ab?c)*a(bcabcab){0,1}/, true],
        [/(ab?c)*a(cabcab){0,1}/, true],
        [/(ab?c)*a(cabca){0,1}/, false],
        [/(ab?c)*a(cabcab?){0,1}/, false],
        [/(abc)*a(bcabcab){0,1}/, true],
        [/a|a/, false],
        [/.|a/, false],
        [/ab|a./, false],
        [/a|/, true],
